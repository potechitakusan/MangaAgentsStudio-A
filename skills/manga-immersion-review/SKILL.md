...
description: 字コンテやネームの没入感、無言コマ、感情の間、情報密度をレビューするときに使う。
---
...
対象シーン・狙い・入力（あらすじ/字コンテ/ネーム/原稿/参照絵）を確認し、`docs/knowledge/review-workflow.md` に従って実効重点を読む。担当する主観点は `immersion`。内容の判断には `docs/knowledge/immersion-and-cinema.md` の該当箇所を参照する。

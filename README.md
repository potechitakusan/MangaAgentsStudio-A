...
- ギャグの場面について、監修スキルから字コンテの表現案とプレビュー後の改善案を得る。
...
版0.3.1には [汎用ノウハウ](docs/knowledge/review-workflow.md#common-knowledge) と [ギャグ監修](docs/knowledge/supervision/gag/README.md) を収録しています。汎用知識は人物・情報・読みやすさ・終幕の判断に、監修スキルは笑いを狙う場面の相談と画像レビューに使います。
...
**A.** 人物・緩急・演技・読みやすさ・レビューのノウハウを拡充し、ギャグのノウハウを `docs/knowledge/supervision/gag/` に追加しました。監修スキル `manga-supervision` は現在ギャグのみ対応し、字コンテの表現相談とPNGプレビューの改善に使えます。
